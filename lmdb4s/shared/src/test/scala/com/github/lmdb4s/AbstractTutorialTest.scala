 ...
 * supported.
 */
trait AbstractTutorialTest[KVProxy, Pointer] extends TestSuite {

  protected val DB_NAME = "my DB"
  protected def createTempDirectory(): java.io.File
  protected def createEnv(): Env.Builder[KVProxy, Pointer]

  private def createSimpleEnv(): Env[KVProxy, Pointer] = {
